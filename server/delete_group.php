...
$linux_user = 'antond';
    ...
    //First deleteing all foreign key entries to the group in users_groups_junction
    
    $q = $mysqli->prepare("delete from users_groups_junction where group_id=$group_id");
    ...
    $q = $mysqli->prepare("delete from groups where group_id=$group_id");
