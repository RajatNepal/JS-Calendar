...
$linux_user = 'antond';
    ...
    $group_event_id = $json_obj["group_event_id"];
    
    //Inserting Date and Datetime objects as strings

    $q = $mysqli->prepare("delete from event where group_event_id=$group_event_id");
    ...
    //Need to also update group_event_junction

    $q = $mysqli->prepare("delete from group_event_junction where group_event_id=$group_event_id");
